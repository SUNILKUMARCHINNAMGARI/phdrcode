...
dataset_metrics_name <- paste("nnet-classification","-","dataset",iter,"-","symmetrical","-","metrics",".","csv",sep="")
dataset_predictions_name <- paste("nnet-classification","-","dataset",iter,"-","symmetrical","-","predictions",".","csv",sep="")  
...
model <- train(zclass ~ ., data = dataset, method = "nnet",trControl = ctrl)

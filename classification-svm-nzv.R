...
dataset_metrics_name <- paste("SVM-classification","-","dataset",iter,"-","nzv","-","metrics",".","csv",sep="")
dataset_predictions_name <- paste("SVM-classification","-","dataset",iter,"-","nzv","-","predictions",".","csv",sep="")  

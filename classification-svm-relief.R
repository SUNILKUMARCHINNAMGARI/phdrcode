...
dataset_metrics_name <- paste("SVM-classification","-","dataset",iter,"-","relief","-","metrics",".","csv",sep="")
dataset_predictions_name <- paste("SVM-classification","-","dataset",iter,"-","relief","-","predictions",".","csv",sep="")  

...
dataset_metrics_name <- paste("c50-classification","-","dataset",iter,"-","tf",num,"-","metrics",".","csv",sep="")
dataset_predictions_name <- paste("c50-classification","-","dataset",iter,"-","tf",num,"-","predictions",".","csv",sep="")  

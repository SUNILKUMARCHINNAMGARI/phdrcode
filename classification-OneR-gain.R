...
dataset_metrics_name <- paste("OneR-classification","-","dataset",iter,"-","gain","-","metrics",".","csv",sep="")
dataset_predictions_name <- paste("OneR-classification","-","dataset",iter,"-","gain","-","predictions",".","csv",sep="")  

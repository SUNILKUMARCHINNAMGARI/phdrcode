...
dataset_metrics_name <- paste("nb-classification","-","dataset",iter,"-","symmetrical","-","metrics",".","csv",sep="")
dataset_predictions_name <- paste("nb-classification","-","dataset",iter,"-","symmetrical","-","predictions",".","csv",sep="")  
...
model <- train(zclass ~ ., data = dataset, method = "nb", trControl = ctrl)

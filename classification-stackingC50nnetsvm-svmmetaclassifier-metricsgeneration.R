...
for(iter in 1:10)
{
  ...
  dataset_metrics_name <- paste("stackingc50nnetsvm-metrics","-","dataset",iter,"-","chi","-","svmmetaclassifier",".","csv",sep="") 
  dataset_predictions_name <- paste("stackingc50nnetsvm-predictions","-","dataset",iter,"-","chi","-","svmmetaclassifier",".","csv",sep="")
  ...
  model <- train(zclass ~ ., data = predictors, method = "svmLinear")

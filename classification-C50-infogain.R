...
dataset_metrics_name <- paste("c50-classification","-","dataset",iter,"-","infogain","-","metrics",".","csv",sep="")
dataset_predictions_name <- paste("c50-classification","-","dataset",iter,"-","infogain","-","predictions",".","csv",sep="")  

...
dataset_metrics_name <- paste("OneR-classification","-","dataset",iter,"-","infogain","-","metrics",".","csv",sep="")
dataset_predictions_name <- paste("OneR-classification","-","dataset",iter,"-","infogain","-","predictions",".","csv",sep="")  

...
dataset_metrics_name <- paste("RIPPER-classification","-","dataset",iter,"-","chi","-","metrics",".","csv",sep="")
dataset_predictions_name <- paste("RIPPER-classification","-","dataset",iter,"-","chi","-","predictions",".","csv",sep="")  

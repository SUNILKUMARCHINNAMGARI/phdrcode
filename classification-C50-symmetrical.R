...
dataset_metrics_name <- paste("c50-classification","-","dataset",iter,"-","symmetrical","-","metrics",".","csv",sep="")
dataset_predictions_name <- paste("c50-classification","-","dataset",iter,"-","symmetrical","-","predictions",".","csv",sep="")  
...
model <- train(zclass ~ ., data = dataset, method = "C5.0", trControl = ctrl)

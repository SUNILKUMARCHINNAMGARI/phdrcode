...
for(iter in 1:10)
{
  ...
  while(num<=25)
  {
    ...
    dataset_metrics_name <- paste("RIPPER-classification","-","dataset",iter,"-","tf",num,"-","metrics",".","csv",sep="")
    dataset_predictions_name <- paste("RIPPER-classification","-","dataset",iter,"-","tf",num,"-","predictions",".","csv",sep="")  

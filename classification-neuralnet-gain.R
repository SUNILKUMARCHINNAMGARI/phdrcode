...
dataset_metrics_name <- paste("nnet-classification","-","dataset",iter,"-","gain","-","metrics",".","csv",sep="")
dataset_predictions_name <- paste("nnet-classification","-","dataset",iter,"-","gain","-","predictions",".","csv",sep="")  

...
for(iter in 1:10)
{
  ...
  dataset_metrics_name <- paste("stackingc50nnetsvm-metrics","-","dataset",iter,"-","chi","-","nnetmetaclassifier",".","csv",sep="") 
  dataset_predictions_name <- paste("stackingc50nnetsvm-predictions","-","dataset",iter,"-","chi","-","nnetmetaclassifier",".","csv",sep="")
  ...
  model <- train(zclass ~ ., data = predictors, method = "nnet")

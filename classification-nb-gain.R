...
dataset_metrics_name <- paste("nb-classification","-","dataset",iter,"-","gain","-","metrics",".","csv",sep="")
dataset_predictions_name <- paste("nb-classification","-","dataset",iter,"-","gain","-","predictions",".","csv",sep="")  

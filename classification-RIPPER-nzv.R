...
dataset_metrics_name <- paste("RIPPER-classification","-","dataset",iter,"-","nzv","-","metrics",".","csv",sep="")
dataset_predictions_name <- paste("RIPPER-classification","-","dataset",iter,"-","nzv","-","predictions",".","csv",sep="")  
